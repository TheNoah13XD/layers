...
import { Fab, Snackbar } from '@components/material';
                ...
                <Section stylize='mt-[74px] px-7'>
                    ...
                    <Section stylize='flex-row mt-7'>
                        ...
                        <Section stylize='flex-1 flex-col justify-between bg-tertiaryContainer rounded-b-[25px] rounded-tl-[25px] w-full h-[290px] py-3 pl-4 pr-2 ml-1'>
                            ...
                            <Fab type='regular' containerColor='bg-tertiaryFixedDim' contentColor='onTertiaryContainer' icon='north-east' stylize='self-end' onPress={() => showError('This feature is not available yet.')} />
                        </Section>
                    </Section>
